...
if __name__ == "__main__":
    print("Loading clinical tabular data...")
    df = load_nhanes_data(data_dir='../data')
    print("\nTraining XGBoost Risk Triage Model...")
    model, explainer, cv_aucs = train_triage_model(df, save_dir='../checkpoints')
    print("\n✅ Training complete! Model saved to checkpoints/triage_xgb.pkl")
