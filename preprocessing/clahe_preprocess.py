...
def preprocess_fundus(img, size=224, apply_ben_graham=True, apply_clahe_step=True,
    ...
    6. Resize to target size (224×224 for EfficientNet-B0)
    7. Float32 conversion + ImageNet normalization
    
    Args:
        img: RGB image as numpy array (uint8)
        size: Final output size (224 for EfficientNet-B0)
